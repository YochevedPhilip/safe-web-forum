...
const CreatePost = () => {
  ...
  const handlePublish = async () => {
    // החזרתי בדיוק את הלוגיקה המקורית שלך כולל ההודעות באנגלית
    if (title.length < 3) {
    ...
    try {
      ...
      setTimeout(() => {
        if (res.status === 201) {
          ...
          // שומר על הלוגיקה של הודעת השגיאה מהשרת
          navigate("/error", {
      ...
      <div className="form-card">
        ...
        {loading && (
          <div style={{ marginBottom: "20px" }}>
            ...
            <p style={{ textAlign: "center", fontSize: "0.8rem", marginTop: "5px" }}>Loading... {progress}%</p>
          </div>
        )}
